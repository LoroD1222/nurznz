  ...
  "inline-flex h-10 items-center justify-center rounded-[5px] px-5 text-center text-[14px] font-semibold leading-[18px] transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-coral disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-[rgba(233,104,85,0.22)] text-coral hover:bg-[rgba(233,104,85,0.3)]",
        "secondary-dark":
          "bg-[rgba(233,104,85,0.34)] text-white hover:bg-[rgba(233,104,85,0.45)]",
        footer:
          "h-11 rounded-[8px] bg-[#ea685a] px-6 text-[#153b3a] shadow-[0_8px_18px_-8px_rgba(0,0,0,0.18)] hover:bg-[#df5f52]",
      },
      size: {
        default: "min-w-[119px]",
        compact: "min-w-[102px]",
